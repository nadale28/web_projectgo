...
function go_page(page, block){
	...
	location.href="admin_reply_list?curPage="+page+"&curBlock="+block;
...
<c:set var="endPage" value="${pageInfo.endPage }"/>
	...
	<img src = 'resources/img/doublearrow.png' width = "20px" height = "20px"
				onclick="${curBlock>1 ? 'go_page(1,1);' :''}"/>
	<c:set var="prev" 
		value="go_page(${beginPage-pageBlock},${curBlock-1});"/>
	<img src = 'resources/img/backarrow.png' width = "20px" height = "20px"
	...
	<img src = "resources/img/forwdoublearrow.png" width = "20px" height = "20px"
