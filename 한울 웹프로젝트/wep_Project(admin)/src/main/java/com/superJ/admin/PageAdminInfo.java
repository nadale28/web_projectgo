...
public class PageAdminInfo {
	final public int pageList = 8;//페이지당 보여질 게시글수 getter 
	final public int pageBlock = 10;//블럭당 보여질 페이지수 getter
	...
	public int begin;
	ArrayList<AdminDTO> list;//보여질 게시글 목록
	...
	public void setList(ArrayList<AdminDTO> list) {
		this.list = list;
	}
